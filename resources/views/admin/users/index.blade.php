...
<div class="w-full px-4 sm:px-6 lg:px-10 py-4 space-y-8">
    ...
    <div class="block md:hidden space-y-4">
        @forelse($users as $u)
        <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">

            {{-- Top accent bar --}}
            <div class="h-1.5 w-full {{ $u->status ? 'bg-gradient-to-r from-[#A65005] to-[#592202]' : 'bg-gray-200' }}"></div>

            {{-- Clickable area --}}
            <a href="{{ route('admin.users.show', $u->id) }}" class="p-4 flex flex-col gap-3 flex-1 hover:bg-[#fdf8f5] transition-colors">
