...
<div class="w-full px-4 sm:px-6 lg:px-10 py-8">
    ...
    <nav class="flex items-center gap-2 text-sm mb-6">
        ...
        <span class="text-[#A65005] font-semibold">Edit Kategori</span>
    </nav>
        ...
        <div class="rounded-t-2xl px-6 py-5 flex items-center justify-between"
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-white/60 text-xs">Perbarui informasi kategori</p>
                </div>
            </div>
            <a href="{{ route('admin.categories.index') }}"
...
slugInput.dataset.manual = 'true'; // edit mode: jangan auto-overwrite slug
